  ...
  const courses = [
    {
      ...
      progress: 75,
      nextLesson: 'Техника "мокрым по мокрому"',
      date: '2024-01-15',
    },
    {
      name: 'Масляная живопись',
      progress: 40,
      nextLesson: 'Портретная живопись',
      date: '2024-01-18',
    },
  ];

  const achievements = [
    { name: 'Первая работа', icon: Award, completed: true },
    { name: 'Мастер акварели', icon: Award, completed: true },
    { name: 'Портретист', icon: Award, completed: false },
  ];
                ...
                {courses.map((course, index) => (
                  <div key={index} className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="flex justify-between items-center text-sm">
                      <span className="text-gray-600">Следующий урок: {course.nextLesson}</span>
